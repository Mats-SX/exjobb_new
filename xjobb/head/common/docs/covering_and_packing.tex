...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_time1};
\addplot table[x=df,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_time1};
\end{axis}
\end{tikzpicture}
...
\addplot table[x=df,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_mem1};
\addplot table[x=df,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_mem1};
\end{axis}
\end{tikzpicture}
...
\addplot table[x=n,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_mem2};
\addplot table[x=n,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/fztlin_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_time1};
\addplot table[x=df,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_time1};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=df,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_mem1};
\addplot table[x=df,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_mem1};
\end{axis}
\end{tikzpicture}
...
\addplot table[x=n,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_mem2};
\addplot table[x=n,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=time (ms)]
\addplot table[x=k,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_time3};
\addplot table[x=k,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_time3};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=k,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_mem3};
\addplot table[x=k,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_cover_mem3};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_time1};
\addplot table[x=df,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_time1};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=df,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_mem1};
\addplot table[x=df,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_mem1};
\end{axis}
\end{tikzpicture}
...
\addplot table[x=n,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_mem2};
\addplot table[x=n,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=time (ms)]
\addplot table[x=k,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_time3};
\addplot table[x=k,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_time3};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=k,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_mem3};
\addplot table[x=k,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_partition_mem3};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=time (ms)]
\addplot table[x=df,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_time1};
\addplot table[x=df,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_time1};
\end{axis}
\end{tikzpicture}
...
xlabel=$df$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=df,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_mem1};
\addplot table[x=df,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_mem1};
\end{axis}
\end{tikzpicture}
...
\addplot table[x=n,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_time2};
\end{axis}
\end{tikzpicture}
...
xlabel=$n$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=n,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_mem2};
\addplot table[x=n,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_mem2};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=time (ms)]
\addplot table[x=k,y=time] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_time3};
\addplot table[x=k,y=systime] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_time3};
\end{axis}
\end{tikzpicture}
...
xlabel=$k$,
ylabel=resident set / virtual memory (MB)]
\addplot table[x=k,y=vm] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_mem3};
\addplot table[x=k,y=rss] {/home/sx/xjobb/exjobb/test_results/fzt_k/k_packing_mem3};
\end{axis}
\end{tikzpicture}
...
\VerbatimInput{/home/sx/xjobb/exjobb/latex/fztlin_code_c++}
