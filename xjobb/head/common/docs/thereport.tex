...
The size of the graph was of course proven to be very significant for HPR performance, and only somewhat significant for BHKK (relatively speaking). In inprecise terms, we would use this recommendation sheet when deciding on which of the two should be chosen to compute the chromatic polynomial:
