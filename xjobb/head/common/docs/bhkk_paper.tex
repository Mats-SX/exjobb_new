...
%TODO: Find source for antiferromagnetic Potts model claim
...
\footnotetext{With variance, we mean $v = \frac{M - m}{M}$ where $M$ is the maximum measured value and $m$ the minimum.}
